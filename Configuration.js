...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("3","state",endpointType.appliance);
  
  var i = endpoints.addEndpoint("4","RPM",endpointType.genericSensor);
  i.variableTypeId = 1135;

  var e = endpoints.addEndpoint("5","test",endpointType.genericSensor);
  e.variableTypeId = 1135;

  var a = endpoints.addEndpoint("6","testData", endpointType.genericSensor);
  a.variableTypeId = 1135;

  var b = endpoints.addEndpoint("7", "demo", endpointType.genericSensor);
  b.variableTypeId = 1135;

  var c = endpoints.addEndpoint("8","io", endpointType.genericSensor);
  c.variableTypeId = 1135;
