...
# Parsing + Configuration Script – TSD-V1-SIA - Rev. A

This **Parsing + Configuration** script is designed for the **TSD-V1-SIA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TSD-V1-SIA Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TSD-V1-SIA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
